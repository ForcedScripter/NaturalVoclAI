        ...
        <main className="min-h-screen bg-[#FFFDF5] text-[#3D2E1A] pt-32 pb-24 px-4">
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <motion.div
                    ...
                    className="mb-16"
                >
                    <h2 className="text-lg tracking-[0.2em] text-[#3D2E1A] uppercase mb-8 text-center">Technology Stack</h2>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {[
                            ...
                            <motion.div
                                ...
                                className="bg-[#C8923C]/[0.03] border border-[#C8923C]/10 rounded-xl p-4 text-center hover:border-brand-gold/20 transition-colors duration-300"
                            >
